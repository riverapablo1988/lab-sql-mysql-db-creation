...
(cust_code, cust_name, cust_phone, cust_email, cust_address, cust_city, cust_state, cust_country, cust_zipcode)
VALUES
...
INSERT INTO salespersons (staff_code, name, store) VALUES
...
UPDATE cars SET status = 'sold' WHERE car_id IN (1,2,3);